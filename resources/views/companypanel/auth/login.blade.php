                ...
                <div class="col-12 col-sm-8 offset-sm-2 col-md-6 offset-md-3 col-lg-6 offset-lg-3 col-xl-4 offset-xl-4">
                    <div class="card card-primary">
                        <div class="text-center mt-1">
                            <img alt="image" src="{{ asset('public/admin/assets/images/mansol-01.png') }}"
                                style="width: 40%" />
                        </div>
                        <div class="card-body">
                            <form method="POST" action="{{ url('company/login') }}" class="needs-validation"
                                novalidate="">
                                @csrf
                                    ...
                                    <div class="custom-control custom-checkbox">
                                        ...
                                        <div class="d-block">
                                            ...
                                            <div class="float-right">
                                                <a href="{{ url('company-forgot-password') }}" class="text-small">
                                                    Forgot Password?
                                                </a>
                                            </div>
                                        </div>
