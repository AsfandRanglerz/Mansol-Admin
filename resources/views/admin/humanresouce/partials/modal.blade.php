...
<div class="steps mb-5">
    @for ($i = 1; $i <= 7; $i++)
        ...
        <div style="cursor: pointer;" class="d-flex flex-column align-items-center position-relative step-container">
...
<div class="form-section active" data-step="1">
    <form id="form-step-1" action="{{ route('submit.step', ['step' => 1]) }}" method="POST"
        ...
        <div class="form-group">
            ...
            @php
                $cv = optional($HumanResource->hrSteps->where('step_number', 1)->where('file_type', 'cv')->first())
                    ->file_name;
                $cvUrl = $cv ? asset($cv) : '';
            @endphp
            ...
            <div class="mt-2">
                <a id="cvReportButton-{{ $HumanResource->id }}" href="{{ $cvUrl }}" target="_blank"
            ...
            <div class="col-md-12 mt-3">
                <div class="form-check">
                    ...
                    <input type="checkbox" class="form-check-input" id="received_physically_passport"
                        ...
                        {{ strtolower($received_physically_passport) === 'yes' ? 'checked' : '' }}>
            ...
            <div class="col-md-6">
                ...
                <div class="position-relative">
                    <img id="cnicFrontPreview-{{ $HumanResource->id }}"
                        ...
                        style="width: 100%; height: 5.5cm; object-fit: contain;" />
                    @if ($cnicFront)
                        <a href="{{ asset($cnicFront) }}" download
                            class="btn btn-primary position-absolute download-btn">
                            <span class="fa-solid fa-download"></span>
                        </a>
                    @endif
                ...
                <div class="col-md-12 mt-2">
                    <div class="form-check">
                        ...
                        <input type="checkbox" class="form-check-input" id="received_physically_cnic_front"
                            ...
                            {{ strtolower($received_physically_cnic_front) === 'yes' ? 'checked' : '' }}>
            ...
            <div class="col-md-6">
                ...
                <div class="position-relative">
                    <img id="cnicBackPreview-{{ $HumanResource->id }}"
                        ...
                        style="width: 100%; height: 5.5cm; object-fit: contain;" />
                    @if ($cnicBack)
                        <a href="{{ asset($cnicBack) }}" download
                            class="btn btn-primary position-absolute download-btn">
                            <span class="fa-solid fa-download"></span>
                        </a>
                    @endif
                ...
                <div class="col-md-12 mt-2">
                    <div class="form-check">
                        ...
                        <input type="checkbox" class="form-check-input" id="received_physically_cnic_back"
                            name="received_physically_cnic_back" value="yes"
                            {{ strtolower($received_physically_cnic_back) === 'yes' ? 'checked' : '' }}>
                        <label class="form-check-label font-weight-bold " for="received_physically_cnic_back">
                            In Hand
                        </label>
                    </div>
                </div>
        ...
        <div class="row mt-4">
            ...
            <div class="col-md-6">
                ...
                <div class="form-group">
                    ...
                    @php
                        $photo = optional(
                            $HumanResource->hrSteps->where('step_number', 4)->where('file_type', 'photo')->first(),
                        )->file_name;
                    @endphp
            ...
            <div class="col-md-6">
                ...
                @php
                    $nokCnicFront = optional(
                        $HumanResource->hrSteps->where('step_number', 5)->where('file_type', 'nok cnic front')->first(),
                    )->file_name;
                @endphp
            ...
            <div class="col-md-6">
                ...
                @php
                    $nokCnicBack = optional(
                        $HumanResource->hrSteps->where('step_number', 5)->where('file_type', 'nok cnic back')->first(),
                    )->file_name;
                @endphp
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                ...
                <select name="process_status" class="form-control" required>
                    ...
                    <option value="Yet to appear" {{ $process_status == 'Yet to appear' ? 'selected' : '' }}>Yet to
                        appear</option>
                    ...
                    <option value="Result Available" {{ $process_status == 'Result Available' ? 'selected' : '' }}>
                        Result Available</option>
                </select>
            </div>
        ...
        <div class="row">
            <div class="col-md-6">
                ...
                <select name="visa_type" class="form-control" required>
                    ...
                    <option value="Work Permit" {{ $visa_type == 'Work Permit' ? 'selected' : '' }}>Work Permit
                    </option>
                    ...
                    <option value="Single Entry" {{ $visa_type == 'Single Entry' ? 'selected' : '' }}>Single Entry
                    </option>
                    <option value="EV" {{ $visa_type == 'EV' ? 'selected' : '' }}>EV</option>
                    <option value="Work Visa" {{ $visa_type == 'Work Visa' ? 'selected' : '' }}>Work Visa</option>
                    <option value="WORK VISIT VISA" {{ $visa_type == 'WORK VISIT VISA' ? 'selected' : '' }}>WORK VISIT
                        VISA</option>
                </select>
            </div>
    ...
    <form id="form-step-3" action="{{ route('submit.step', ['step' => 3]) }}" method="POST"
        ...
        <div class="row mb-3">
            ...
            <div class="col-md-6 pl-2 d-flex align-items-end">
                ...
                <button id="" class="btn btn-primary generatePdfBtn" style="margin-bottom: 2px">Generate
                    PDF</button>

                <a style="margin-bottom: 2px; margin-left: 8px;"
                    class="btn btn-info pdfReportButton 
