                        ...
                        <div class="row">
                            <div class="col-md-4">
                                ...
                                <div class="position-relative">
                                    <img id="passportFrontPreview-{{ $HumanResource->id }}"
                                        ...
                                        data-existing-src="{{ $passportFront ? asset($passportFront) : '' }}" />
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="position-relative"><img id="passportBackPreview-{{ $HumanResource->id }}"
                                        ...
                                        data-existing-src="{{ $passportBack ? asset($passportBack) : '' }}"
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="position-relative"><img id="passportPreviewThree-{{ $HumanResource->id }}"
                                        ...
                                        data-existing-src="{{ $passportImageThree ? asset($passportImageThree) : '' }}"
                                        style="width: 100%; height: 5.5cm; object-fit: contain;" /><button
                                        class="btn btn-primary position-absolute download-btn">
                                        <span class="fa-solid fa-download"></span>
                                    </button>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="position-relative">
                                    <img id="cnicFrontPreview-{{ $HumanResource->id }}"
                                        ...
                                        data-existing-src="{{ $cnicFront ? asset($cnicFront) : '' }}"
                                        style="width: 100%; height: 5.5cm; object-fit: contain;" />
                                    <button class="btn btn-primary position-absolute download-btn">
                                        <span class="fa-solid fa-download"></span>
                                    </button>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="position-relative">
                                    <img id="cnicBackPreview-{{ $HumanResource->id }}"
                                        ...
                                        data-existing-src="{{ $cnicBack ? asset($cnicBack) : '' }}"
                                        style="width: 100%; height: 5.5cm; object-fit: contain;" />
                                    <button class="btn btn-primary position-absolute download-btn">
                                        <span class="fa-solid fa-download"></span>
                                    </button>
                            ...
                            <div class="form-group">
                                ...
                                <div class="position-relative">
                                    <img id="photoPreview-{{ $HumanResource->id }}"
                                        ...
                                        data-existing-src="{{ $photo ? asset($photo) : '' }}"
                            ...
                            <div class="form-group">
                                ...
                                <div class="position-relative">
                                    <img id="policeCertificate-{{ $HumanResource->id }}"
                                        ...
                                        data-existing-src="{{ $policePhoto ? asset($policePhoto) : '' }}"
                                        style="width: 3.5cm; height: 4.5cm; object-fit: contain;" />
                                    {{-- @if ($photo) --}}
                                        <button class="btn btn-primary position-absolute download-btn">
                                            <span class="fa-solid fa-download"></span>
                            ...
                            <div class="form-group">
                                ...
                                <div class="position-relative">
                                    <img id="accountDetail-{{ $HumanResource->id }}"
                                        ...
                                        data-existing-src="{{ $accountPhoto ? asset($accountPhoto) : '' }}"
                                        style="width: 3.5cm; height: 4.5cm; object-fit: contain;" />
                                    {{-- @if ($photo) --}}
                                        <button class="btn btn-primary position-absolute download-btn">
                                            <span class="fa-solid fa-download"></span>
                            ...
                            <div class="form-group">
                                ...
                                <div class="position-relative">
                                    <img id="updatedAppraisal-{{ $HumanResource->id }}"
                                        ...
                                        data-existing-src="{{ $appraisalPhoto ? asset($appraisalPhoto) : '' }}"
                                        style="width: 3.5cm; height: 4.5cm; object-fit: contain;" />
                                    {{-- @if ($photo) --}}
                                        <button class="btn btn-primary position-absolute download-btn">
                                            <span class="fa-solid fa-download"></span>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="position-relative">
                                    <img id="nokCnicFrontPreview-{{ $HumanResource->id }}"
                                        ...
                                        data-existing-src="{{ $nokCnicFront ? asset($nokCnicFront) : '' }}"
                                        style="width: 100%; height: 5.5cm; object-fit: contain;" />
                                    <button class="btn btn-primary position-absolute download-btn">
                                        <span class="fa-solid fa-download"></span>
                                    </button>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="position-relative">
                                    ...
                                    <img id="nokCnicBackPreview-{{ $HumanResource->id }}"
                                        ...
                                        data-existing-src="{{ $nokCnicBack ? asset($nokCnicBack) : '' }}"
                                        style="width: 100%; height: 5.5cm; object-fit: contain;" />
                                </div>
                            </div>
                        </div>
                ...
                <div class="form-section" data-step="2">
                    <form id="form-step-2" action="{{ route('submit.step', ['step' => 2]) }}" method="POST"
                        ...
                        @php
                            ...
                            $original_report_received = $step->original_report_recieved ?? false;
...
<script>
    ...
    if (file.size > maxBytes) {
        ...
        if (previewElement && previewElement.dataset.existingSrc) {
            previewElement.src = previewElement.dataset.existingSrc;
            previewElement.classList.remove("d-none");
